...
import { Dialog as SheetPrimitive,
          ...
          DialogFooter as SheetPrimitiveFooter,
          DialogHeader as SheetPrimitiveHeader,
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        {showCloseButton && (
          <SheetPrimitiveClose data-slot="sheet-close" asChild>
